...
class RepositoryFactory {
  static const String _defaultTiaoWenDataPath = 'assets/data/tiao_wen_data.json';

  /// 创建条文Repository实例
  /// 
  /// [dataPath] 数据文件路径，默认使用预设路径
  /// 返回条文Repository实例
  static TiaoWenRepository createTiaoWenRepository({
    String? dataPath,
  }) {
    return TiaoWenRepositoryImpl(
      dataPath: dataPath ?? _defaultTiaoWenDataPath,
    );
  }
