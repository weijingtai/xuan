...
class GenerateFourGuaAtom extends AtomicOperation {
  ...
  @override
  Map<String, ParameterDefinition> get inputParameters => {
    'fourZhu': ParameterDefinition(
      name: 'fourZhu',
      type: ParameterType.any,
      required: true,
      description: '',
    ),
    'threeYuan': ParameterDefinition(
      name: 'threeYuan',
    ...
    'config': ParameterDefinition(
      ...
      type: ParameterType.dict,
      required: true,
      description: '包含所有计算策略的配置对象',
    ),
  };

  @override
  Map<String, ParameterDefinition> get outputParameters => {
    'basicGua': ParameterDefinition(
      name: 'basicGua',
      type: ParameterType.str,
      required: true,
      description: '',
    ),
    'basicNumber': ParameterDefinition(
      name: 'basicNumber',
      type: ParameterType.intNum,
      required: true,
      description: '',
    ),
    'variationBase': ParameterDefinition(
      name: 'variationBase',
      type: ParameterType.intNum,
      required: true,
      description: '',
    ),
    'fourGuaList': ParameterDefinition(
      name: 'fourGuaList',
      type: ParameterType.array,
      required: true,
      description: '',
...
class GetChangePositionsAtom extends AtomicOperation {
  GetChangePositionsAtom()
    : super(
        id: 'get_change_positions',
        name: '获取变爻位置',
        category: '领域专用',
        description: '根据余数获取需要变化的爻位置',
        version: 'v0.1',
      );
  @override
  Map<String, ParameterDefinition> get inputParameters => {
    'remainder': ParameterDefinition(
      name: 'remainder',
      type: ParameterType.intNum,
      required: true,
      description: '',
...
class ApplyGuaExchangeTransformAtom extends AtomicOperation {
  ApplyGuaExchangeTransformAtom()
    : super(
        id: 'apply_gua_exchange_transform',
        name: '执行卦变换',
        category: '领域专用',
        description: '执行卦的变爻和上下交换',
        version: 'v0.1',
      );
  @override
  Map<String, ParameterDefinition> get inputParameters => {
    'gua': ParameterDefinition(
      name: 'gua',
      type: ParameterType.str,
      required: true,
      description: '',
...
class GetGuaThreeNumbersAtom extends AtomicOperation {
  GetGuaThreeNumbersAtom()
    : super(
        id: 'get_gua_three_numbers',
        name: '获取卦三数',
        category: '领域专用',
        description: '获取一个卦对应的天地人三数',
        version: 'v0.1',
      );
  @override
  Map<String, ParameterDefinition> get inputParameters => {
...
class CalculateTiaowenFromNumbersAtom extends AtomicOperation {
  CalculateTiaowenFromNumbersAtom()
    : super(
        id: 'calculate_tiaowen_from_numbers',
        name: '根据三数计算条文',
        category: '领域专用',
        description: '根据天地人三数计算条文列表',
        version: 'v0.1',
      );
  @override
  Map<String, ParameterDefinition> get inputParameters => {
  ...
  @override
  Map<String, ParameterDefinition> get outputParameters => {
    'tiaowenList': ParameterDefinition(
      name: 'tiaowenList',
      type: ParameterType.array,
      required: true,
      description: '',
