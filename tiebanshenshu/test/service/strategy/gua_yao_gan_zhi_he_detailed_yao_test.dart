...
void main() {
  ...
  group('Detailed Yao Tests - GUI_WEI GUI_HAI REN_WU WU_SHEN', () {
    ...
    test('Year Pillar - Di Shan Qian (地山谦) - Yao Details', () {
      ...
      expect(yaos[0].naTianGan, equals(TianGan.BING), reason: 'Yao 0 should be BING');
      expect(yaos[0].naDiZhi, equals(DiZhi.CHEN), reason: 'Yao 0 should be CHEN');
      
      expect(yaos[1].naTianGan, equals(TianGan.BING), reason: 'Yao 1 should be BING');
      expect(yaos[1].naDiZhi, equals(DiZhi.WU), reason: 'Yao 1 should be WU');
      
      expect(yaos[2].naTianGan, equals(TianGan.BING), reason: 'Yao 2 should be BING');
      expect(yaos[2].naDiZhi, equals(DiZhi.SHEN), reason: 'Yao 2 should be SHEN');
      
      expect(yaos[3].naTianGan, equals(TianGan.GUI), reason: 'Yao 3 should be GUI');
      expect(yaos[3].naDiZhi, equals(DiZhi.CHOU), reason: 'Yao 3 should be CHOU');
      
      expect(yaos[4].naTianGan, equals(TianGan.GUI), reason: 'Yao 4 should be GUI');
      expect(yaos[4].naDiZhi, equals(DiZhi.HAI), reason: 'Yao 4 should be HAI');
      
      expect(yaos[5].naTianGan, equals(TianGan.GUI), reason: 'Yao 5 should be GUI');
    ...
    test('Month Pillar - Di Shui Shi (地水师) - Yao Details', () {
      ...
      expect(yaos[0].naTianGan, equals(TianGan.WU), reason: 'Yao 0 should be WU');
      expect(yaos[0].naDiZhi, equals(DiZhi.YIN), reason: 'Yao 0 should be YIN');
      
      expect(yaos[1].naTianGan, equals(TianGan.WU), reason: 'Yao 1 should be WU');
      expect(yaos[1].naDiZhi, equals(DiZhi.CHEN), reason: 'Yao 1 should be CHEN');
      
      expect(yaos[2].naTianGan, equals(TianGan.WU), reason: 'Yao 2 should be WU');
    ...
    test('Day Pillar - Tian Huo Tong Ren (天火同人) - Yao Details', () {
      ...
      expect(yaos[0].naTianGan, equals(TianGan.JI), reason: 'Yao 0 should be JI');
      expect(yaos[0].naDiZhi, equals(DiZhi.MAO), reason: 'Yao 0 should be MAO');
      
      expect(yaos[1].naTianGan, equals(TianGan.JI), reason: 'Yao 1 should be JI');
      expect(yaos[1].naDiZhi, equals(DiZhi.CHOU), reason: 'Yao 1 should be CHOU');
      
      expect(yaos[2].naTianGan, equals(TianGan.JI), reason: 'Yao 2 should be JI');
      expect(yaos[2].naDiZhi, equals(DiZhi.HAI), reason: 'Yao 2 should be HAI');
      
      expect(yaos[3].naTianGan, equals(TianGan.REN), reason: 'Yao 3 should be REN');
      expect(yaos[3].naDiZhi, equals(DiZhi.WU), reason: 'Yao 3 should be WU');
      
      expect(yaos[4].naTianGan, equals(TianGan.REN), reason: 'Yao 4 should be REN');
      expect(yaos[4].naDiZhi, equals(DiZhi.SHEN), reason: 'Yao 4 should be SHEN');
      
      expect(yaos[5].naTianGan, equals(TianGan.REN), reason: 'Yao 5 should be REN');
    ...
    test('Time Pillar - Shui Tian Xu (水天需) - Yao Details', () {
      ...
      expect(yaos[0].naTianGan, equals(TianGan.JIA), reason: 'Yao 0 should be JIA');
      expect(yaos[0].naDiZhi, equals(DiZhi.ZI), reason: 'Yao 0 should be ZI');
      
      expect(yaos[1].naTianGan, equals(TianGan.JIA), reason: 'Yao 1 should be JIA');
      expect(yaos[1].naDiZhi, equals(DiZhi.YIN), reason: 'Yao 1 should be YIN');
      
      expect(yaos[2].naTianGan, equals(TianGan.JIA), reason: 'Yao 2 should be JIA');
      expect(yaos[2].naDiZhi, equals(DiZhi.CHEN), reason: 'Yao 2 should be CHEN');
      
      expect(yaos[3].naTianGan, equals(TianGan.WU), reason: 'Yao 3 should be WU');
      expect(yaos[3].naDiZhi, equals(DiZhi.SHEN), reason: 'Yao 3 should be SHEN');
      
      expect(yaos[4].naTianGan, equals(TianGan.WU), reason: 'Yao 4 should be WU');
      expect(yaos[4].naDiZhi, equals(DiZhi.XU), reason: 'Yao 4 should be XU');
      
      expect(yaos[5].naTianGan, equals(TianGan.WU), reason: 'Yao 5 should be WU');
    ...
    test('All four pillars should produce expected base numbers', () {
      ...
      expect(yearModel.baseNumber, equals(3342), reason: 'Year pillar should be 3342');
      expect(monthModel.baseNumber, equals(3326), reason: 'Month pillar should be 3326');
      expect(dayModel.baseNumber, equals(3945), reason: 'Day pillar should be 3945');
      expect(timeModel.baseNumber, equals(2648), reason: 'Time pillar should be 2648');
    });
  });
}
