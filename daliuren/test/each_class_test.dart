...
void main() {
  group("create daliuren with zeike(贼克)", ()
  {
    ...
    Map<DiZhi,GuiRen> currentDiGodsMapper = Map<DiZhi,GuiRen>.fromIterables(diSeq, guiRenNameList);
    ...
    test("课：$sky$ground，日干：$dayGan。贼克：“$zeike”，日干克上神，上神日干阴阳不同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("癸")!, 1, DiZhi.getFromValue(sky)!, DiZhi.getFromValue(ground)!, GuiRen.GUI_REN);
    ...
    test("课：午申，日干：壬。贼克：“克”，日干克上神，上神日干阴阳同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("壬")!, 1, DiZhi.WU, DiZhi.SHEN, GuiRen.GUI_REN);
    ...
    test("课：午申，日干：辛。贼克：“克”，上神克日干，上神日干阴阳不同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("辛")!, 1, DiZhi.WU, DiZhi.SHEN, GuiRen.GUI_REN);
      expect(eachClass.zeiKeType, EachClassZeiKeType.KE);
      expect(eachClass.isSkyKeDayGan, true);
      expect(eachClass.isSkySameYinYangWithDayGan, false);
    });
    test("课：午申，日干：甲。贼克：“克”，上神无关日干，上神日干阴阳同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("甲")!, 1, DiZhi.WU, DiZhi.SHEN, GuiRen.GUI_REN);
      expect(eachClass.zeiKeType, EachClassZeiKeType.KE);
      expect(eachClass.isSkyKeDayGan, null);
      expect(eachClass.isSkySameYinYangWithDayGan, true);
    });
    test("课：午申，日干：乙。贼克：“克”，上神无关日干，上神日干阴阳同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("乙")!, 1, DiZhi.WU, DiZhi.SHEN, GuiRen.GUI_REN);
      expect(eachClass.zeiKeType, EachClassZeiKeType.KE);
      expect(eachClass.isSkyKeDayGan, null);
      expect(eachClass.isSkySameYinYangWithDayGan, false);
    });
    ...
    test("课：午亥，日干：甲。贼克：“贼”，上神无关日干，上神日干阴阳同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("甲")!, 1, DiZhi.WU, DiZhi.HAI, GuiRen.GUI_REN);
      expect(eachClass.zeiKeType, EachClassZeiKeType.ZEI);
      expect(eachClass.isSkyKeDayGan, null);
      expect(eachClass.isSkySameYinYangWithDayGan, true);
    });
    test("课：午亥，日干：乙。贼克：“贼”，上神无关日干，上神日干阴阳同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("乙")!, 1, DiZhi.WU, DiZhi.HAI, GuiRen.GUI_REN);
      expect(eachClass.zeiKeType, EachClassZeiKeType.ZEI);
      expect(eachClass.isSkyKeDayGan, null);
      expect(eachClass.isSkySameYinYangWithDayGan, false);
    });
    ...
    test("课：午未，日干：乙。贼克：“无”，上神无关日干，上神日干阴阳同", () {
      EachClass eachClass = FourClass.createEachClass(TianGan.getFromValue("乙")!, 1, DiZhi.WU, DiZhi.WEI, GuiRen.GUI_REN);
