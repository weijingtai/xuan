...
void main(){
  group("create daliuren with 反吟", ()
  {
    ...
    List<DiZhi> tianPanList_dev="午未申酉戌亥子丑寅卯辰巳".split("").map((e)=>DiZhi.getFromValue(e)!).toList();
    ...
    test("反吟 无克", () {
      ...
      ThreeChuan? yaoKe = DaLiuRenKePan.checkByFanYin(dayJiaZi,fourClass,currentPanWithGods);
      print("${yaoKe!.first.diZhi.value},${yaoKe.second.diZhi.value},${yaoKe.third.diZhi.value}");
