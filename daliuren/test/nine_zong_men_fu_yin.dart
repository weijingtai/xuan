...
void main(){
  group("create daliuren with 伏吟", ()
  {
    ...
    test("伏吟 1 克", () {
      List<DiZhi> diPanList_dev=  "子丑寅卯辰巳午未申酉戌亥".split("").map((e)=>DiZhi.getFromValue(e)!).toList();
      List<DiZhi> tianPanList_dev="子丑寅卯辰巳午未申酉戌亥".split("").map((e)=>DiZhi.getFromValue(e)!).toList();
      ...
      ThreeChuan? yaoKe = DaLiuRenKePan.checkByFuYin(dayJiaZi,fourClass,currentPanWithGods);
