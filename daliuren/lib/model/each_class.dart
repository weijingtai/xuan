...
class EachClass{
  ...
  bool? isSkyKeDayGan; // 上神是否是克“日干”的 上神克日干时为“true”, 上神受日干克为“false”，上神与日干无关系时为“null”
  ...
  EachClass({
    ...
    // 当前为“贼” -- “下克上”
    bool isZei = FiveXingRelationship.checkRelationship(sky.fiveXing, ground.fiveXing) == FiveXingRelationship.KE;
    if(isZei){
      zeiKeType = EachClassZeiKeType.ZEI;
    }
    // 当前为“克” -- “上克下”
    bool isKe = FiveXingRelationship.checkRelationship(ground.fiveXing, sky.fiveXing) == FiveXingRelationship.KE;
    if (isKe){
      zeiKeType = EachClassZeiKeType.KE;
    }
  }
  factory EachClass.fromJson(Map<String, dynamic> json) => _$EachClassFromJson(json);
