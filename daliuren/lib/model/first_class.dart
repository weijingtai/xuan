...
class FirstClass extends EachClass{
  ...
  FirstClass({
  ...
  }):super(order:0,sky:sky,ground:tenGanJiGongMapper[tianGan]!,guiRen: guiRen,isFirstClass:true){
    // 当前为“贼” -- “下克上”
    bool isZei = FiveXingRelationship.checkRelationship(sky.fiveXing, tianGan.fiveXing) == FiveXingRelationship.KE;
    zeiKeType = null;
    isSkyKeDayGan = null;
    if(isZei){
    ...
    // 当前为“克” -- “上克下”
    bool isKe = FiveXingRelationship.checkRelationship(tianGan.fiveXing, sky.fiveXing) == FiveXingRelationship.KE;
    if (isKe){
  ...
  factory FirstClass.fromJson(Map<String, dynamic> json) => _$FirstClassFromJson(json);
