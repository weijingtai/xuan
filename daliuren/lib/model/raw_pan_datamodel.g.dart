...
Map<String, dynamic> _$RawPanToJson(RawPan instance) => <String, dynamic>{
      ...
      'ju': instance.ju,
      'four': instance.four.map((e) => e.toJson()).toList(),
      'three': instance.three.map((e) => e.toJson()).toList(),
      'gong': instance.gong
...
Map<String, dynamic> _$RawPanCollectionToJson(RawPanCollection instance) =>
    <String, dynamic>{
      'yangData': instance.yangData.map((e) => e.toJson()).toList(),
      'yinData': instance.yinData.map((e) => e.toJson()).toList(),
    };
