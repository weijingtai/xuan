...
class GetYuDingEntryUseCaseParams {
  ...
  GetYuDingEntryUseCaseParams(
      {required this.dayJiaZi, required this.ganShangDiZhi});
...
class GetYuDingEntryUseCase
    implements UseCase<YuDingEntry, GetYuDingEntryUseCaseParams> {
  ...
  Future<Either<Failure, YuDingEntry>> call(
    ...
    if (params.dayJiaZi.isEmpty || params.ganShangDiZhi.isEmpty) {
      return Left(InvalidInputFailure(
          "DayJiaZi and GanShangDiZhi parameters cannot be empty."));
    }
    return Future.value(Failure.notImplemented());
    // return await _repository.getYuDingEntry(
    // params.dayJiaZi, params.ganShangDiZhi);
  }
}
