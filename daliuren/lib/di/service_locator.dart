...
Future<void> setupServiceLocator() async {
  ...
  sl.registerLazySingleton<ShenShaDataService>(() => ShenShaDataServiceImpl());
  ...
  sl.registerLazySingleton(
      () => CalculateShenShaUseCase(sl<ShenShaCalculationService>()));
  sl.registerLazySingleton(
      () => GetShenShaAtLocationUseCase(sl<ShenShaCalculationService>()));
  sl.registerLazySingleton(
      () => FindShenShaByNameUseCase(sl<ShenShaCalculationService>()));
