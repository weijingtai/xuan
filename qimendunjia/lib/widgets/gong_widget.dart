              ...
              Opacity(
                ...
                child: Transform.scale(
                    ...
                    child: QiMenGongContentBackground(
                      ...
                      nineStarsNameTextStyle: pan.isStarFanYin ||
                              pan.isStarFuYin
                          ? nineStarsNameTextStyle.copyWith(color: Colors.black)
                          ...
                          Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: _getNineXingWangShuai(
                                    gongWangShuai.starMonthWangShuai),
                              ),
                              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          gongWangShuai.tianPanMonthZhangSheng.name,
                        ...
                        buildGanWithXunHeaderHint(
                            pan.xunHeaderTianGan, gong.tianPan),
                        const Expanded(child: SizedBox()),
                        buildGanWithXunHeaderHint(
                            pan.xunHeaderTianGan, gong.diPan),
                        Text(
                          gongWangShuai.diPanMonthZhangSheng.name,
                          style: const TextStyle(
                              fontSize: 12,
                              height: 1,
                            ...
                            child: Column(
                              children: [
                                if (gong.tianPanJiGan != null) ...[
                                  ...
                                  buildJiGanWithXunHeaderHint(
                                      pan.xunHeaderTianGan, gong.tianPanJiGan),
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  width: sideWidth,
                  alignment: Alignment.centerLeft,
                  child: gongWangShuai.doorGongRelationship != null
                      ? doorAndGong(gongWangShuai.doorGongRelationship!)
                      : null,
                )
              ],
            )),
        ...
        child: AnimatedContainer(
          ...
          child: Stack(
            ...
            children: [
              ...
              if (isKongWang) buildKongWangCircle(style.color!),
              if (withHorseStar)
                SizedBox(
                    width: 24, height: 24, child: buildHorseStar(style.color!)),
            ],
          ),
        ),
      ),
        ...
        child: AnimatedContainer(
          ...
          child: Stack(
            ...
            children: [
              ...
              if (isKongWang) buildKongWangCircle(style.color!),
              if (withHorseStar) buildHorseStar(style.color!)
            ],
          ),
        ),
      ),
