...
class _EachGongWidgetState extends State<EachGongWidget> {
  ...
  Widget buildTenGanKeYingGeJu() {
    ...
    if (widget.tenGanKeYingGeJu.tianPanJiGan != null &&
        widget.pan.zhiFuGan == widget.tenGanKeYingGeJu.tianPanJiGan) {
      tenGanKeYingGeJu = widget.tenGanKeYingGeJu.tianPanJiGanGeJu!;
    }
    if (widget.tenGanKeYingGeJu.diPanJiGan != null &&
        widget.pan.zhiFuGan == widget.tenGanKeYingGeJu.diPanJiGan) {
                    ...
                    child: widget.backgroundGong == null
                        ...
                        : QiMenGongContentBackground(
                            ...
                            nineStarsNameTextStyle:
                                pan.isStarFanYin || pan.isStarFuYin
                            ...
                            eightSkyDoorTextStyle:
                                pan.isDoorFanYin || pan.isDoorFuYin
  ...
  Widget _buildDoor(
    ...
    return Stack(alignment: Alignment.bottomCenter, children: [
      Container(
        height: 46,
        alignment: Alignment.bottomCenter,
        child: gong.door == widget.pan.zhiShiDoor
            ? SizedBox(width: 64, child: _buildZhiShiDoor())
            : const SizedBox(),
      ),
      Column(
