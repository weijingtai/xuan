              ...
              children: [
                ...
                Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border(
                        bottom: BorderSide(color: nineStarsNameTextStyle.color??Colors.grey,width: 1),
                      ),
                      // color: Colors.red
                    ),
                    child:AutoSizeText(
                      ...
                      maxFontSize: 18,
                      minFontSize: 12,
                      style: nineStarsNameTextStyle.copyWith(fontWeight: FontWeight.w600),
                    )
                  // child: Text,
                ),
                Expanded(child: Container()),
                        ...
                        Opacity(
                          opacity: .8,
                            child: Transform.scale(
                              scale:.7,
                                child: Season24Tag(name:qiMen.jieQiTuple.item1, fontColor:color, borderColor: color, backgroundColor:color.withOpacity(.2),fontStyle: eightSeasonTextStyle,))),
