...
class _ResizableGongWidgetState extends State<ResizableGongWidget> {
  ...
  UITenGanKeYingGeJu get tenGanKeYingGeJu => widget.uiGongModel.tenGanKeYingGeJu;
  ...
  bool get isJiStarZhiFu=>gong.isJiTianQin && widget.uiGongModel.panMete.zhiFuStar == NineStarsEnum.QIN;
    ...
    return AnimatedContainer(
      ...
      child: Stack(
        children: [
                        ...
                        Row(
                          ...
                          children: [
                            AnimatedContainer(
                              ...
                              child: yinAnGanColumn(jiFontSize,hintFontSize,isHor),
                            ),
                            AnimatedContainer(
                              duration: duration,
                              width: fontSize * 3,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    width: fontSize * 3,
                                    alignment: Alignment.center,
                                    child: _gods(gong.god,fontSize* 2,hintFontSize),
                                  ),
                                  SizedBox(
                                      width: fontSize * 3,
                                      child: _stars(gong.star,fontSize,jiFontSize,hintFontSize,gong.isJiTianQin, isHor)
                                  ),
                                  Container(
                                      width: fontSize * 3,
                                      alignment: Alignment.center,
                                      child: Column(
                                        children: [
                                          ...
                                          _doors(gong.door,fontSize,hintFontSize),
                                          Text(gong.diGod.name,style: ConstantUiResourcesOfQiMen
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                tianDiPanGanMarked(gong.tianPan,wangShuai.tianPanMonthZhangSheng,wangShuai.tianPanAnGanGongZhangSheng,fontSize,hintFontSize,jiFontSize,showHint,gong.tianPanJiGan,wangShuai.tianPanJiGanMonthZhangSheng,wangShuai.tianPanJiGanGongZhangSheng),
                                SizedBox(height: 4,),
                                tianDiPanGanMarked(gong.diPan,wangShuai.diPanMonthZhangSheng,wangShuai.diPanGongZhangSheng,fontSize,hintFontSize,jiFontSize,showHint,gong.diPanJiGan,wangShuai.diPanJiGanMonthZhangSheng,wangShuai.diPanJiGanMonthZhangSheng,isTianPan: false),
                              ],
                            )
                          ],
                        ),
          ...
          if (widget.uiGongModel.qiYiRuGongList != null && widget.uiGongModel.qiYiRuGongList!.isNotEmpty  &&displayGeJu)
            AnimatedPositioned(
                right: paddingSideWidth * .5,
                top: 0,
                bottom: 0,
  ...
  Widget buildThreeQiRuGong(List<QiYiRuGong> qiYiRuGongList){
    return Row(
      children: qiYiRuGongList.map((qi)=>Stack(
        alignment: Alignment.center,
        children: [
          SizedBox(
            width: 32,
            ...
            child: RotatedBox(
              ...
              child: ColorFiltered(
                  colorFilter: ColorFilter.mode(
                      ConstResourcesMapper.jiXiongColorMapper[qi.geJuJiXiong]!,
                      BlendMode.srcIn),
          ...
          Column(
            ...
            children: qi.geJuName
                .split("")
                .map((c)=>Text(c,style: GoogleFonts.maShanZheng(fontSize: 16,height: 1.0,color: Colors.white)))
                .toList(),
          )
        ],
      )).toList()
  ...
  Widget buildGongGeJu(){
    ...
    if (gongGeJu.tianPanJiGanWithDiPanList != null && gongGeJu.tianPanJiGanWithDiPanList!.isNotEmpty){
      mostGeJu.addAll(gongGeJu.tianPanJiGanWithDiPanList!);
    }
    if (gongGeJu.tianPanWithDiPanJiGanList != null && gongGeJu.tianPanWithDiPanJiGanList!.isNotEmpty){
      mostGeJu.addAll(gongGeJu.tianPanWithDiPanJiGanList!);
    }
    if (gongGeJu.tianDiJiGanList != null && gongGeJu.tianDiJiGanList!.isNotEmpty){
      mostGeJu.addAll(gongGeJu.tianDiJiGanList!);
    }
    List<Widget> geJuWidgets = mostGeJu.map((geJu) => geJu.jiXiong.isJi()
        ? ge_ju_template_small(geJu.name,geJu.jiXiong,Color.fromRGBO(59,78,61, 1),Color.fromRGBO(240, 167, 46, 1))
        : GeJuPanelTemplateXiong1( name:geJu.name, backgroundColor: Color.fromRGBO(63, 75, 80,1),foregroundColor: Color.fromRGBO(185, 128, 124, 1), size: Size(120,32),)
    ).toList();
    ...
    List<Widget> nineDun =[
      ...
      gongGeJu.tianDiJiPanNineDun,
        ...
        .map((nineDun)=>ge_ju_template_small(nineDun!.name,JiXiongEnum.JI,
         Color.fromRGBO(32, 50, 54, 1),
    ...
    return Row(
      ...
      crossAxisAlignment: CrossAxisAlignment.center,
      children:[
        if (geJuWidgets.isNotEmpty)
          geJuWidgets.first,
        if (nineDun.isNotEmpty)
          nineDun.first,
        if (nineDun.isEmpty && zhaJiaList.isNotEmpty)
          zhaJiaList.first,
      ],
    );
  }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          image: DecorationImage(
              ...
              colorFilter: ColorFilter.mode(ConstResourcesMapper.jiXiongColorMapper[tenGanKeYingGeJu.jiXiong]!, BlendMode.srcIn),
              fit: BoxFit.cover
          )
      ),
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(nameChar[0],style: ConstantUiResourcesOfQiMen.eightSkyDoorTextStyle.copyWith(fontSize: 52 * .3,color: Colors.white)),
              Text(nameChar[1],style: ConstantUiResourcesOfQiMen.eightSkyDoorTextStyle.copyWith(fontSize: 52 * .3,color: Colors.white)),
          ...
          Column(
            ...
            children: [
              ...
              Text(nameChar[2],style: ConstantUiResourcesOfQiMen.eightSkyDoorTextStyle.copyWith(fontSize: 52 * .3,color: Colors.white)),
              Text(nameChar[3],style: ConstantUiResourcesOfQiMen.eightSkyDoorTextStyle.copyWith(fontSize: 52 * .3,color: Colors.white)),
            ],
          )
        ],
      ),
        ...
        children: [
          SizedBox(
              ...
              child:Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  WangShuaiHint(textTuple2:Tuple2(wangShuai.godGongWangShuai.name,""),size:hintBoxSize,showHint: showHint,duration: duration,),
                  isSingleChar
                      ? Container(
                    alignment: Alignment.center,
                    height: miniFontSize,
                    width: miniFontSize,
                    child: Text(god.name.split("").last,
                      maxLines: 1,
                      style: ConstantUiResourcesOfQiMen.nineStarTextStyle.copyWith(
                ...
                children: [
                  Container(
                    // color:Colors.yellow.withOpacity(.1),
                      child: WangShuaiHint(textTuple2:Tuple2(wangShuai.doorMonthWangShuai.name,wangShuai.doorGongWangShuai.name),size:hintBoxSize,showHint: showHint,duration: duration,)),
                  isSingleChar
                      ? Container(
                    alignment: Alignment.center,
                    height: miniFontSize,
                  ...
                  AnimatedContainer(
                    ...
                    child: AnimatedSwitcher(
                      ...
                      child: showHint && wangShuai.doorGongRelationship != null
                          ...
                          ?_buildDescYinZhang(wangShuai.doorGongRelationship!,sideWidth,centerBoxHeight)
                          :Container(),
                    ),
                  ),
                ],
  ...
  Widget _stars(NineStarsEnum star,double fontSize,double jiFontSize,double hintSize,bool isJiTianQin,bool isHor){
          ...
          children: [
            Positioned(
              ...
              child: SizedBox(
                ...
                child: Row(
                  children: [
                    WangShuaiHint(size:Size(hintSize,miniFontSize), showHint:showHint,duration: Duration(milliseconds: 400),textTuple2: Tuple2("旺", "衰"),),
                    Container(
                      alignment: Alignment.center,
                      height: miniFontSize,
                      width: miniFontSize,
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      WangShuaiHint(size:Size(hintSize,miniFontSize * 0.75), showHint:showHint,duration: duration,textTuple2: Tuple2(wangShuai.starMonthWangShuai.name,wangShuai.starGongWangShuai.name),),
    ...
    TextStyle tianQinFontStyle =  ConstantUiResourcesOfQiMen.nineStarTextStyle.copyWith(fontSize: jiFontSize,shadows: [
      Shadow(
        offset: Offset(1, 1),
        blurRadius: 3,
        color: Colors.grey,
        ...
        children: [
          ...
          if (isZhiFuStar)
            isHor?Positioned(
                ...
                child: _buildZhiFuStar(fontSize >= 16?maxWidth + hintSize*2:16+8)
            ):
            Positioned(
                top: 0,
                left: 0,
          ...
          AnimatedPositioned(
            ...
            child:WangShuaiHintTopDown(
              top:Container(
                ...
                height: hintSize,
                // height: height,
                alignment: isHor?Alignment.bottomRight:Alignment.bottomCenter,
                // alignment: Alignment.topCenter,
                child: AutoSizeText(
              ...
              size:isHor?Size(hintSize,fontSize):Size(fontSize, (fontSize+hintSize)*2),
              showHint: showHint,
              duration: duration,
          ...
          // 寄天禽 旺衰
            AnimatedPositioned(
              ...
              child: WangShuaiHintTopDown(
                ...
                size:isHor?Size(hintSize,jiFontSize):Size(jiFontSize, (jiFontSize+hintSize)*2),
                showHint: showHint,
                duration: duration,
                alignment: isHor?Alignment.centerRight:Alignment.center,
              ),
          ...
          if (isJiTianQin)
            AnimatedPositioned(
              ...
              left: isHor?boxMaxWidth-hintSize-jiFontSize*2:fontSize * .7, // `fontSize * .7` UI显示更紧凑，为中间腾出空间
              right: isHor?0:null,
              duration: duration,
                  ...
                  child: Stack(
                      ...
                      children:[
                        Container(
                          ...
                          height: jiFontSize,
                          alignment: Alignment.center,
                          child: Text(NineStarsEnum.QIN.name.split("").first,style:tianQinFontStyle),
                        ),
                        AnimatedContainer(
                            duration:Duration(milliseconds: 200),
                            ...
                            child: Container(
                              ...
                              width: jiFontSize,
                              alignment: Alignment.center,
                              child: Text(NineStarsEnum.QIN.name.split("").last,style:tianQinFontStyle),
                            )
                        ),
                      ]
                  )
  ...
  Widget _buildDescYinZhang(GongAndDoorRelationship gongAndDoorRelationship,double width,double height){
    return Container(
        width: width,
        height: height,
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                ...
                //
                colorFilter: ColorFilter.mode(
                              ConstantUiResourcesOfQiMen.gongDoorRelationshipColorMapper[gongAndDoorRelationship]!,
                              BlendMode.srcIn),
  ...
  Widget tianDiPanGanMarked(
      ...
      {bool isTianPan = true}){
    bool? isMuOrKu = NineYiUtils.checkMuOrKu(panMeta.monthToken,gan,gong.gongGua);
    bool? isJiGanMuOrKu = jiGan==null?null:NineYiUtils.checkMuOrKu(panMeta.monthToken,jiGan,gong.gongGua);
    return Row(
      mainAxisAlignment: MainAxisAlignment.start,
              ...
              children: [
                ...
                if(isJiGanMuOrKu != null)
                  SizedBox(
                    ...
                    child: ColorFiltered(
                        colorFilter: ColorFilter.mode(
                            isJiGanMuOrKu?Colors.red.shade800:Colors.blue.shade600,
                            BlendMode.srcIn),
                        // child: Image.asset("assets/icons/thin-black-ink-circle.png")
                        child: Image.asset("assets/icons/mu.png")
                    ),
              ...
              Positioned(
                ...
                child: Opacity(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Text(yinAnGan.split("").first,style: TextStyle(color: Colors.black87,fontSize: tagTextFontSize,fontWeight: FontWeight.w300,height: 1),),
                        if (tagTextFontSize>=8)
                          Text(yinAnGan.split("").last,style: TextStyle(color: Colors.black87,fontSize: tagTextFontSize,fontWeight: FontWeight.w300,height: 1),),
                      ],
                    ),
                  ),
                ),
  ...
  Widget topSidePanelContent(Size size){
    ...
    if (panMeta.timeXunKong.toList().contains(diZhi) || panMeta.horseLocation == diZhi){
      return Container(
        width: size.width,
        height: size.height,
        alignment: Alignment.bottomCenter,
        child: diZhi == null?Container():AnimatedSwitcher(
          duration:duration,
          child: size.height < 10 ?Container():_buildKongWangOrHorseStar(size.height,diZhi),
        ),
      );
    }
    return  Container(
      ...
      child: diZhi == null?Container():AnimatedSwitcher(
        duration:duration,
        child: size.height < 10 ?Container():AutoSizeText(
          diZhi.name,
          style: ConstantUiResourcesOfQiMen.twelveDiZhiTextStyle.copyWith(color: ConstResourcesMapper.zodiacZhiColors[diZhi]!.withOpacity(.8)),
          minFontSize: 10,
          maxFontSize: 32,
        ),
      ),
  ...
  Widget leftSidePanelContent(Size size){
    ...
    if (panMeta.timeXunKong.toList().contains(diZhi) || panMeta.horseLocation == diZhi){
      return Container(
        ...
        child: diZhi == null?Container():AnimatedSwitcher(
          duration:duration,
          child: size.width < 10 ?Container():_buildKongWangOrHorseStar(size.width,diZhi),
        ),
      );
    }
      return Container(
      ...
      child: diZhi == null?Container():AnimatedSwitcher(
        duration:duration,
        child: size.width < 10 ?Container():AutoSizeText(
          diZhi.name,
          style: ConstantUiResourcesOfQiMen.twelveDiZhiTextStyle.copyWith(color: ConstResourcesMapper.zodiacZhiColors[diZhi]!.withOpacity(.8)),
          minFontSize: 10,
          maxFontSize: 32,
  ...
  Widget ge_ju_template_small(String name, JiXiongEnum jiXiong, Color color, Color backColor){
                ...
                Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                          ...
                          image: AssetImage("assets/icons/ji_xiong_yin_zhang.png",)
                      ),
                    ),
                    child: AutoSizeText(
                      "吉",
                      style: GoogleFonts.longCang(height: 1.0,color: color,fontWeight: FontWeight.w600,shadows: [Shadow(color: Colors.white.withOpacity(.4),blurRadius: 4)]),
                      maxLines: 1,
                      minFontSize: 8,
                      maxFontSize: 16,
                    )
      ...
      decoration: panMeta.timeXunKong.toList().contains(diZhi)
        ...
        image:DecorationImage(
            ...
            colorFilter: ColorFilter.mode(
                ...
                BlendMode.srcIn),
            image: AssetImage("assets/icons/thin-black-ink-circle.png")),
      ):null,
      child: panMeta.horseLocation != diZhi?SizedBox():_buildHorseStar(ConstResourcesMapper.zodiacZhiColors[diZhi]!),
