...
class ScalableShiJiaQiMenViewPage extends StatefulWidget {
  ...
  @override
  State<ScalableShiJiaQiMenViewPage> createState() => _ScalableShiJiaQiMenViewPageState();
}

class _ScalableShiJiaQiMenViewPageState extends State<ScalableShiJiaQiMenViewPage> with TickerProviderStateMixin {
  ...
  Size panSize = Size(604, 604); // default 816,816
              ...
              children: [
                ...
                if (explains.uiGongTenGanKeYing.tianPanJiDiPanKeYing != null)
                  buildNewExplainList(
                      ...
                      [uiGong.tenGanKeYingGeJu.tianJiGanJiaGeJu,uiGong.tenGanKeYingGeJu.tianDunJiaDiPanJi,uiGong.tenGanKeYingGeJu.tianPanJiGanGeJu!],
  ...
  Widget buildPanGeJu(ShiJiaQiMen pan){
    ...
    if (pan.panGeJuList != null && pan.panGeJuList!.isNotEmpty){
      pan.panGeJuList!.forEach((geJu){
        if (geJu.jiXiong.isJi()){
          list.add(GeJuPanelTemplateJi1(name:geJu.name,
              backgroundColor: Color.fromRGBO(86,0,79, 1), // 紫棠
              foregroundColor: Color.fromRGBO(242,190,69, 1)));
        }else{
          list.add(GeJuPanelTemplateXiong1(
            ...
            backgroundColor:  Color.fromRGBO(130,78,64, 1),
            foregroundColor: Color.fromRGBO(33,33,33, 1),size: Size(180,42),));
        }
      });
    }
    list.addAll(pan.bingGeList.map((geJu)=>
      GeJuPanelTemplateXiong1(
        name:geJu.name,
        backgroundColor:  Color.fromRGBO(130,78,64, 1),
        foregroundColor: Color.fromRGBO(33,33,33, 1),size: Size(180,42),)
    ));
    list.addAll(pan.gengGeList.map((geJu)=>
      GeJuPanelTemplateXiong1(
        name:geJu.name,
        backgroundColor: Color.fromRGBO(250,237,223,1),
        foregroundColor:Color.fromRGBO(240, 167, 46, 1),size: Size(180,42),)
    ));
      return SizedBox(
      height: 64,
      child: Column(
                  ...
                  children: [
                    if (popularGeJuList != null)
                      ... popularGeJuList.map((e){
                        if (e.jiXiong.isJi()){
                          return GeJuPanelTemplateJi1(name: e.name,  backgroundColor:Color.fromRGBO(59,78,61, 1),
                              foregroundColor: Color.fromRGBO(240, 167, 46, 1));
                        }else{
                    ...
                    if (nineDunEnum != null)
                      GeJuPanelTemplateJi1(name: nineDunEnum.name,  backgroundColor: Color.fromRGBO(32, 50, 54, 1),
