...
class _ShiJiaQiMenViewPageState extends State<ShiJiaQiMenViewPage>
  ...
  Widget buildGlassLayer() {
    return ValueListenableBuilder(
        ...
        builder: (ctx, popup, child) {
          ...
          ).animate(controller: _panScaleController, autoPlay: false).fadeIn(
              delay: const Duration(milliseconds: 100),
              duration: const Duration(milliseconds: 200));
        });
  }
      ...
      child: Hero(
          ...
          child: Container(
            ...
            child: NewEachGongWidget(
              ...
              backgroundGong: uiGong.gua == HouTianGua.Center
                  ? null
                  : ConstantResourcesOfQiMen.defaultGongMapper[uiGong.gua]!,
