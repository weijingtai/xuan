...
class ScalableBeautifulPage extends StatefulWidget {
  DateTime? panDateTime;
  ScalableBeautifulPage({super.key,this.panDateTime});

  @override
  State<ScalableBeautifulPage> createState() => _ScalableBeautifulPageState();
}

class _ScalableBeautifulPageState extends State<ScalableBeautifulPage> with TickerProviderStateMixin {
        ...
        builder: (ctx,pan,child){
          ...
          if (pan != null) {
            if (EnumMostPopularGeJu.isTianXianShiGe(
              ...
              list.add(GeJuPanelTemplateJi1(name: "天显时格", backgroundColor: Color.fromRGBO(32, 50, 54, 1), foregroundColor: Color.fromRGBO(209, 181, 146, 1)));
            }
            ...
            if (EnumMostPopularGeJu.isWuBuYuShi(pan.dayJiaZi, pan.timeJiaZi) != null){
              ...
              list.add(GeJuPanelTemplateXiong1(
                  ...
                  foregroundColor: Color.fromRGBO(88,15,5, 1), size: Size(180,48),));
            }
          }
          return SizedBox(
            height: 64,
    ...
    return GestureDetector(
      ...
      child:Hero(
          ...
          child: Container(
            ...
            //         wangShuai:pan.gongWangShuaiMapper[gua]!,
