...
abstract class ShiJiaQiMenJuCalculator{
  ...
  static final YANG_DUN_JIE_QI_JU_NUMER = {
    TwentyFourJieQi.DONG_ZHI:Tuple3(1,7,4),
    TwentyFourJieQi.XIAO_HAN:Tuple3(2,8,5),
    TwentyFourJieQi.DA_HAN:Tuple3(3,9,6),
    TwentyFourJieQi.LI_CHUN:Tuple3(8,5,2),
    TwentyFourJieQi.YU_SHUI:Tuple3(9,6,3),
    TwentyFourJieQi.JING_ZHE:Tuple3(1,7,4),
    TwentyFourJieQi.CHUN_FEN:Tuple3(3,9,6),
    TwentyFourJieQi.QING_MING:Tuple3(4,1,7),
    TwentyFourJieQi.GU_YU:Tuple3(5,2,8),
    TwentyFourJieQi.LI_XIA:Tuple3(4,1,7),
    TwentyFourJieQi.XIAO_MAN:Tuple3(5,2,8),
    TwentyFourJieQi.MANG_ZHONG:Tuple3(6,3,9),
  };
  static List<Tuple3<int,EnumThreeYuan,TwentyFourJieQi>> get yangDunList {
    ...
    for (var entries in YANG_DUN_JIE_QI_JU_NUMER.entries) {
       ...
       result.add(Tuple3(entries.value.item2, EnumThreeYuan.MIDDLE, entries.key));
       result.add(Tuple3(entries.value.item3, EnumThreeYuan.END, entries.key));
    }
    return result;
  }
  static final YIN_DUN_JIE_QI_JU_NUMER = {
    TwentyFourJieQi.XIA_ZHI:Tuple3(9,3,6),
    TwentyFourJieQi.XIAO_SHU:Tuple3(8,2,5),
    TwentyFourJieQi.DA_SHU:Tuple3(7,1,4),

    TwentyFourJieQi.LI_QIU:Tuple3(2,5,8),
    TwentyFourJieQi.CHU_SHU:Tuple3(1,4,7),
    TwentyFourJieQi.BAI_LU:Tuple3(9,3,6),

    TwentyFourJieQi.QIU_FEN:Tuple3(7,1,4),
    TwentyFourJieQi.HAN_LU:Tuple3(6,9,3),
    TwentyFourJieQi.SHUANG_JIANG:Tuple3(5,8,2),

    TwentyFourJieQi.LI_DONG:Tuple3(6,9,3),
    TwentyFourJieQi.XIAO_XUE:Tuple3(5,8,2),
    TwentyFourJieQi.DA_XUE:Tuple3(4,7,1),
...
class ChaiBuCalculator extends ShiJiaQiMenJuCalculator{
  ...
  static JiaZi getFuTouByDayJiaZi(JiaZi dayGanZhi){
    ...
    if (_model % 5 == 0){
      ...
      // 当前日干支为 符头的前一个
      fuTou = JiaZi.getByNumber(dayGanZhi.number - _model + 1);
    }
    return fuTou;
  }
  ...
  ShiJiaJu _doCalculate(){
    ...
    // 根据符头地支查看三元
    EnumThreeYuan threeYuan = ShiJiaQiMenJuCalculator.getThreeYuanByFuHead(fuTou);
    ...
    return ShiJiaJu(
      panDateTime: dateTime,
        ...
        jieQiAt: jieQi,
        jieQiStartAt: DateFormat("yyyy-MM-dd HH:mm:ss").parse(lunar.getJieQiTable()[jieQi.name]!.toYmdHms()),
        jieQiEnd:TwentyFourJieQi.fromName(lunar.getNextJieQi().getName()),
        jieQiEndAt: DateFormat("yyyy-MM-dd HH:mm:ss").parse(lunar.getNextJieQi().getSolar().toYmdHms()),
        atThreeYuan: threeYuan,
        fourZhuEightChar: [lunar.getYearInGanZhi(),lunar.getMonthInGanZhi(),dayGanZhi.name,lunar.getTimeInGanZhi()].join(" ").toString()
    );
    // return ShiJiaJu();
  }
}
...
class ZhiRunCalculator extends ShiJiaQiMenJuCalculator{
  ...
  ShiJiaJu _doCalculate(){
    ...
    if (dateTime.hour == 23){
      ...
      // 影响年月日的干支
      lunar = Lunar.fromDate(dateTime.add(Duration(hours: 1)));
    }

    JiaZi dayJiaZi = JiaZi.getFromGanZhiValue(lunar.getDayInGanZhi())!;
    String eightChar = [lunar.getYearInGanZhi(),lunar.getMonthInGanZhi(),dayJiaZi.name,timeGanZhi].join(" ").toString();


    // 起局时间所在的这一年节气
    String jieQiName = lunar.getCurrentJieQi()?.getName() ?? lunar.getPrevJieQi().getName();
    TwentyFourJieQi jieQi = TwentyFourJieQi.fromName(jieQiName);
    DateTime jieQiStartAt = dateFormatter.parse(lunar.getJieQiTable()[jieQi.name]!.toYmdHms());
    // 1. 根据节气查看当前节气是阴遁还是阳遁
  ...
  Tuple4<int,EnumThreeYuan,TwentyFourJieQi,int> doCa(DateTime dateTime){
    ...
    final lastZhengShouDongZhiDateTime = ZhengShouDongZhiList.getPreviousZhengShouDongZhi(dateTime);
    ...
    if (dateTime.hour == 23){
      // 如果时间为子时 则天为下一天
      diffInDays += 1;
      findLunarByDateTime.add(Duration(hours: 1));
    }
  ...
  Tuple4<int,EnumThreeYuan,TwentyFourJieQi,int> insideOneYear(DateTime zhengShouDongZhi,DateTime targetDateTime){
    DateTime _targetTime = targetDateTime;
    if (_targetTime.hour == 23){
      _targetTime = _targetTime.add(Duration(hours: 1)); // 给为第二天
    }
    int finalDiffDays = _targetTime.difference(zhengShouDongZhi).inDays;
    List<Tuple3<int,
        EnumThreeYuan,
        TwentyFourJieQi>> dunList = [];
    ...
    return Tuple4(
        dunList.first.item1, dunList.first.item2, dunList.first.item3, finalDiffDays % 5 +1 );

  }
  Tuple4<int,EnumThreeYuan,TwentyFourJieQi,int>  otherYears(DateTime zhengShouDongZhi,DateTime panDateTime) {
    ...
    if (targetDateTime.hour == 23){
      targetDateTime = targetDateTime.add(Duration(hours: 1)); // 给为第二天
    }
    ...
    for (var i = yearStart; i <= targetEnd; i++) {
      ...
      DateTime thisYearDongZhi = dateFormatter.parse(
          tmpLunar.getJieQiTable()["冬至"]!.toYmdHms());
      DateTime thisYearXiaZhi = dateFormatter.parse(
          tmpLunar.getJieQiTable()["夏至"]!.toYmdHms());
      // TODO 没有根据子时修改为第二天

      // 将时间调整为 前一天子时开始时间
      thisYearDongZhi = DateTime(
          thisYearDongZhi.year, thisYearDongZhi.month, thisYearDongZhi.day - 1,
          22, 59, 59);
      thisYearXiaZhi = DateTime(
          thisYearXiaZhi.year, thisYearXiaZhi.month, thisYearXiaZhi.day - 1, 22,
          59, 59);
    ...
    TwentyFourJieQi previousTwoZhiJie = TwentyFourJieQi
        .fromName(targetDateJieQi)
        .yinYangDun
        .isYang ? TwentyFourJieQi.DONG_ZHI : TwentyFourJieQi.XIA_ZHI;
    DateTime previousJieQiDateTime = dateFormatter.parse(
        targetLunar.getJieQiTable()[previousTwoZhiJie.name]!.toYmdHms());


    // TODO 没有根据子时修改为第二天
    // 将时间调整为 前一天子时开始时间
    previousJieQiDateTime = DateTime(
        previousJieQiDateTime.year, previousJieQiDateTime.month,
        previousJieQiDateTime.day, 0, 1);
    ...
    if (targetDateTime.month == 12 && targetDateTime.day >= 18) {
      ...
      DateTime _theDongZhiDate = dateFormatter.parse(
          tmp2Lunar.getJieQiTable()["冬至"]!.toYmdHms());
      if (_theDongZhiDate.isBefore(targetDateTime)) {
        _theDongZhiDate = DateTime(_theDongZhiDate.year, _theDongZhiDate.month,
            _theDongZhiDate.day - 1, 22, 59, 59);
        dateTimes.add(_theDongZhiDate);
      }
    }
    ...
    for (int i = 1; i < dateTimes.length; i++) {
      daysBetweenEachTwoZhi.add(dateTimes[i]
          .difference(dateTimes[i - 1])
          .inDays + 1);
    }
      ...
      if (i == 0 || i % 2 == 0) {
        ...
        if (days == 180) {
          ...
          if (days - 180 >= 9) {
            ...
            dunList.addAll(ShiJiaQiMenJuCalculator.yangDunList.sublist(ShiJiaQiMenJuCalculator.yangDunList.length - 3));
          } else {
        ...
        if (days == 180) {
          ...
          if (days - 180 >= 9) {
            ...
            dunList.addAll(ShiJiaQiMenJuCalculator.yinDunList.sublist(ShiJiaQiMenJuCalculator.yinDunList.length - 3));
            // print(
    ...
    if (dunList.length * 5 <= totalDiffInDays) {
      if (finishedDun.isYang) { // 阳遁list已经结束了
    ...
    return Tuple4(
        resultList.first.item1, resultList.first.item2, resultList.first.item3, totalDiffInDays % 5 +1 );
  }

  @Deprecated("")
  Tuple4<int,EnumThreeYuan,TwentyFourJieQi,int>  otherYears2(DateTime zhengShouDongZhi,DateTime targetDateTime) {
    // Tuple4<int,EnumThreeYuan,TwentyFourJieQi,int> otherYears(int diffInDays,DateTime findLunarByDateTime){
    Lunar startLunar = Lunar.fromDate(zhengShouDongZhi);
    Lunar targetLunar = Lunar.fromDate(targetDateTime);
    ...
    if (finishedDun.isYang) { // 阳遁list已经结束了
      ...
      if (nextDunShuldBe == EnumZhiRunType.CHAO_SHEN) {
        dunList =
            ShiJiaQiMenJuCalculator.yinDunList.skip((previousLoopBalance) ~/ 5)
                .toList();
        // dunList.addAll(ShiJiaQiMenJuCalculator.yinDunList);
        // return Tuple4(
        ...
        if (completedYuan == 0) {
          dunList = [
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator.yangDunList.length - 2],
            ShiJiaQiMenJuCalculator.yangDunList.last];
        } else if (completedYuan == 1) {
          dunList = [
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator.yangDunList.length - 3],
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator.yangDunList.length - 2],
            ShiJiaQiMenJuCalculator.yangDunList.last
          ];
        } else if (completedYuan == 2) {
          dunList = [
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator.yangDunList.length - 4],
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator.yangDunList.length - 3],
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator.yangDunList.length - 2],
            ShiJiaQiMenJuCalculator.yangDunList.last
          ];
        ...
        if (completedYuan == 0) {
          ...
          dunList = [
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator
                .yangDunList.length - 4],
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator
                .yangDunList.length - 3],
            ShiJiaQiMenJuCalculator.yangDunList[ShiJiaQiMenJuCalculator
                .yangDunList.length - 2],
            ShiJiaQiMenJuCalculator.yangDunList.last
          ];
        }
        dunList.addAll(ShiJiaQiMenJuCalculator.yinDunList);
      ...
      if (nextDunShuldBe == EnumZhiRunType.CHAO_SHEN) {
        dunList =
            ShiJiaQiMenJuCalculator.yangDunList.skip(previousLoopBalance ~/ 5)
                .toList();
        // return Tuple4(
        //     dunList.first.item1, dunList.first.item2, dunList.first.item3,
        //     previousLoopBalance % 5 + 1);
        ...
        if (completedYuan == 0) {
          dunList = [
            ShiJiaQiMenJuCalculator.yinDunList[ShiJiaQiMenJuCalculator
                .yinDunList.length - 2],
        ...
        print("阴遁 置润 $previousLoopBalance $completedYuan ${previousLoopBalance % 5 + 1}");
        // throw UnimplementedError("使用阴遁 置润");
        // return Tuple4(
        //     dunList.first.item1, dunList.first.item2, dunList.first.item3,
        //     (15 - previousLoopBalance) % 5);
    ...
    print("diff in days targetDateTime - lastTwoZhi $finalDiffInDays, $previousLoopBalance = ${previousLoopBalance - finalDiffInDays}");
    ...
    return Tuple4(
        dunList.first.item1, dunList.first.item2, dunList.first.item3, finalDiffInDays % 5 +1 );
  }
  @Deprecated("")
  Tuple4<int,EnumThreeYuan,TwentyFourJieQi,int> insideOneYear2(int diffInDays,DateTime findLunarByDateTime){
    Lunar dateTimeInLunar = Lunar.fromDate(findLunarByDateTime);
    var dongZhi = dateFormatter.parse(dateTimeInLunar.getJieQiTable()["冬至"]!.toYmdHms());
    var dongZhiJieDateOnly = DateTime(dongZhi.year, dongZhi.month, dongZhi.day);
    var xiaZhi = dateFormatter.parse(dateTimeInLunar.getJieQiTable()["夏至"]!.toYmdHms());
    var xiaZhiJieDateOnly = DateTime(xiaZhi.year, xiaZhi.month, xiaZhi.day);
    print("目标时间（$findLunarByDateTime） 当年 冬至节（$dongZhiJieDateOnly）, 夏至节（$xiaZhiJieDateOnly）");
    if (dateTime.isAtSameMomentAs(xiaZhiJieDateOnly)||dateTime.isAfter(xiaZhiJieDateOnly)){


      // 冬至节之后使用的阳遁
      int afterThatYearDongZhiDays = dateTime.difference(dongZhiJieDateOnly).inDays;
      if (dateTime.hour == 23){
      ...
      var afterZhengShouInDays = xiaZhiJieDateOnly.difference(dongZhiJieDateOnly).inDays + 1; // +1 为加上冬至节 这天

      print("当年夏至节距离正授冬至节 ${afterZhengShouInDays}天");
      if (afterZhengShouInDays == 180){
        ...
        if (leftToXiaZhi == 0){
          // 使用阳遁第一局
          return Tuple4(ShiJiaQiMenJuCalculator.yangDunList.first.item1, ShiJiaQiMenJuCalculator.yangDunList.first.item2, ShiJiaQiMenJuCalculator.yangDunList.first.item3, 1);
      ...
      var yinDunList = ShiJiaQiMenJuCalculator.yinDunList.skip(completedFinishedYuan);



      print("ok");
      return Tuple4(yinDunList.first.item1, yinDunList.first.item2, yinDunList.first.item3, completedDay+1);
      ...
      if (diffInDays < 180){
        ...
        print("相差与正授冬至相差 $diffInDays天 完成的过完$completedFinishedYuan个‘元’ 零 $completedDay 天");
        print(ShiJiaQiMenJuCalculator.yangDunList.length);
        var yangDunList = ShiJiaQiMenJuCalculator.yangDunList.skip(completedFinishedYuan);

        // print("当前为：${yangDunList.first.item3.name} ${yangDunList.first.item2.name} ${yangDunList.first.item1}局 第${completedDay}天");
        return Tuple4(yangDunList.first.item1, yangDunList.first.item2, yangDunList.first.item3, completedDay+1);
      }
      else{
        // 180 天之后，属于阴遁，需要使用夏至
        // 但需要检查是否超接置润
        ...
        if (leftNotCountingDays >= 9){
          // 置润方法为，重复芒种节三元
          // 获取 最后3个item
          var lastThree = ShiJiaQiMenJuCalculator.yinDunList.skip(ShiJiaQiMenJuCalculator.yinDunList.length - 3);
          ...
          return Tuple4(dunList.first.item1, dunList.first.item2, dunList.first.item3, completedDay+1);
        }
        else{
          // 不需要置润，返回阳遁即刻
          // var days = diffInDays - 180;
  ...
  Tuple4<int,EnumThreeYuan,TwentyFourJieQi,int> doCa1(DateTime dateTime){
    ...
    if (diffYears == 0){
      ...
      if (diffInDays < 180){
        ...
        print("当前为：${yangDunList.first.item3.name} ${yangDunList.first.item2.name} ${yangDunList.first.item1}局 第${completedDay+1}天");
        return Tuple4(yangDunList.first.item1, yangDunList.first.item2, yangDunList.first.item3, completedDay+1);
      }
    }
    else{
      ...
      var getAllHelper = lastZhengShouDongZhiDateTime.add(Duration(days: 365));
      for (int i = 0; i < diffYears; i++) {
        var _lunar = Lunar.fromDate(getAllHelper.add(Duration(days: 365 * diffYears)));
        twoZhiList.add(Tuple2(TwentyFourJieQi.DONG_ZHI, dateFormatter.parse(_lunar.getJieQiTable()["冬至"]!.toYmdHms())));
        twoZhiList.add(Tuple2(TwentyFourJieQi.XIA_ZHI, dateFormatter.parse(_lunar.getJieQiTable()["夏至"]!.toYmdHms())));
      }
...
class MaoShanCalculator extends ShiJiaQiMenJuCalculator{
  ...
  ShiJiaJu _doCalculate(){
    ...
    DateTime jieQiStartAt = dateFormatter.parse(lunar.getJieQiTable()[jieQi.name]!.toYmdHms());
    // 节气开始时间应该为当天干支的子时
    jieQiStartAt = DateTime(jieQiStartAt.year,jieQiStartAt.month,jieQiStartAt.day-1,23,0,0);
    DateTime nextJieQiEndAt = dateFormatter.parse(lunar.getJieQiTable()[lunar.getNextJieQi().getName()]!.toYmdHms());
    DateTime jieQiEndAt = nextJieQiEndAt.subtract(Duration(days: 1));
    jieQiEndAt = DateTime(jieQiEndAt.year,jieQiEndAt.month,jieQiEndAt.day,23,0,0);
    ...
    int diffHourPanDateWithStartDate = dateTime.difference(jieQiStartAt).inHours;
    ...
    if (diffHourPanDateWithStartDate <= 180){
      ...
      juNumber = dun.item1;
    }else if (diffHourPanDateWithStartDate <= 360 && diffHourPanDateWithStartDate > 180){
    ...
    return ShiJiaJu(
        panDateTime: dateTime,
        juNumber: juNumber,
        fuTouJiaZi: JiaZi.getFromGanZhiValue(Lunar.fromDate(jieQiStartAt).getDayInGanZhi())!,
...
class YinPanCalculator extends ShiJiaQiMenJuCalculator{
  ...
  ShiJiaJu _doCalculate(){
    ...
    int juNumber = (yearZhiIndex + lunar.getMonth() + lunar.getDay() + timeZhiIndex) % 9;
    if (juNumber == 0){
      juNumber = 9;
    }
    // 冬至后使用阳遁，夏至后使用阴遁
