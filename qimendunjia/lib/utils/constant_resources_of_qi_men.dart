...
class ConstantResourcesOfQiMen{
  static final Map<HouTianGua,ConstantQiMenNineGongDataClass> defaultGongMapper={
    HouTianGua.Qian : ConstantQiMenNineGongDataClass(NineStarsEnum.XIN,EightDoorEnum.KAI,Tuple3("立冬", "小雪","大雪"), "乾", "陆", Tuple2("戌","亥"),tianMenDiHu: "天门"),
    HouTianGua.Kan:ConstantQiMenNineGongDataClass(NineStarsEnum.PENG,EightDoorEnum.XIU,Tuple3("冬至", "小寒","大寒"), "坎", "壹", Tuple2("子",null)),
    HouTianGua.Gen: ConstantQiMenNineGongDataClass(NineStarsEnum.REN,EightDoorEnum.SHENG,Tuple3("立春", "雨水","惊蛰"), "艮", "捌", Tuple2("丑","寅"),tianMenDiHu: "鬼方"),
    HouTianGua.Dui: ConstantQiMenNineGongDataClass(NineStarsEnum.ZHU,EightDoorEnum.JING_W,Tuple3("秋分", "寒露","霜降"), "兑", "柒", Tuple2("酉",null)),
    HouTianGua.Xun:ConstantQiMenNineGongDataClass(NineStarsEnum.FU,EightDoorEnum.DU,Tuple3("立夏","小满","芒种"), "巽", "肆", Tuple2("辰","巳"),tianMenDiHu: "地户"),
    HouTianGua.Li:ConstantQiMenNineGongDataClass(NineStarsEnum.YING,EightDoorEnum.JING_S,Tuple3("夏至","小暑","大暑"), "离", "玖", Tuple2("午",null)),
    HouTianGua.Kun:ConstantQiMenNineGongDataClass(NineStarsEnum.RUI,EightDoorEnum.SI,Tuple3("立秋","处暑","白露"),"坤", "贰", Tuple2("未","申"),tianMenDiHu: "人路"),
    HouTianGua.Zhen:ConstantQiMenNineGongDataClass(NineStarsEnum.CHONG,EightDoorEnum.SHANG,Tuple3("春分", "清明","谷雨"),"震", "叁", Tuple2("卯",null)),
  };
