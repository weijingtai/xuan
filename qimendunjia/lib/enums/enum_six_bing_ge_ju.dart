...
enum EnumSixBingGeJu{
  ...
  static List<EnumSixBingGeJu> checkBingGeForPanel(ShiJiaQiMen pan) {
    ...
    TianGan yearGan = pan.yearJiaZi.tianGan == TianGan.JIA ? pan
        .xunHeaderTianGan : pan.yearJiaZi.tianGan;
    TianGan monthGan = pan.monthJiaZi.tianGan == TianGan.JIA ? pan
        .xunHeaderTianGan : pan.monthJiaZi.tianGan;
    TianGan timeGan = pan.timeJiaZi.tianGan == TianGan.JIA ? pan
        .xunHeaderTianGan : pan.timeJiaZi.tianGan;
    TianGan dayGan = pan.dayJiaZi.tianGan == TianGan.JIA
        ? pan.xunHeaderTianGan
        : pan.dayJiaZi.tianGan;
    List<EnumSixBingGeJu> finalResults = [];
    List<EnumSixBingGeJu> _ganAsTianPan(TianGan diPanGan){
    ...
    for (var entries in pan.gongMapper.entries) {
      ...
      if (gong.diPanJiGan != null && gong.diPanJiGan == TianGan.BING && gong.tianPan == pan.zhiFuGan){
        finalResults.add(Fly);
      }
    }
    return finalResults;
