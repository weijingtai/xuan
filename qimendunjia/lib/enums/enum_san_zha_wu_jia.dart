...
enum SanZhaWuJiaEnum{
  ...
  static EachGongSanZhaWuJia checkSanZhaWuJiaByEachGong(EachGong gong){
    SanZhaWuJiaEnum? tianPan = checkSanZhaWuJia(gong.tianPan, gong.door, gong.god);
    SanZhaWuJiaEnum? tianPanJiGan = checkSanZhaWuJia(gong.tianPan, gong.door, gong.god);
    return EachGongSanZhaWuJia(tianPanGan: tianPan, tianPanJiGan: tianPanJiGan);
  }
  static SanZhaWuJiaEnum? checkSanZhaWuJia(TianGan gan,EightDoorEnum door, EightGodsEnum god){

    if (TianGan.REN == gan){
      return EightDoorEnum.JING_W == door && EightGodsEnum.JIU_TIAN == god?SanZhaWuJiaEnum.Ren_Jia:null;
      ...
      else if ([EightDoorEnum.KAI,EightDoorEnum.XIU,EightDoorEnum.SHENG].contains(door)){
        switch(god){
      ...
      if (EightDoorEnum.SHANG == door){
        ...
        return [EightGodsEnum.TAI_YIN,EightGodsEnum.LIU_HE,EightGodsEnum.JIU_DI].contains(god)?SanZhaWuJiaEnum.Di_Jia:null;
      }
    }
    return null;
  }
  ...
  static bool isSanZha(TianGan gan,EightDoorEnum door, EightGodsEnum god){
    ...
    && [EightGodsEnum.TAI_YIN,EightGodsEnum.LIU_HE,EightGodsEnum.JIU_DI].contains(god);
  }
