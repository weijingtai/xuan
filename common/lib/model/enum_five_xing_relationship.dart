...
enum FiveXingRelationship {
  ...
  static const Map<FiveXing,Map<FiveXing, FiveXingRelationship>> _checkerMapper = {
    FiveXing.JIN: {
  ...
  static FiveXingRelationship? checkRelationship(FiveXing thisElement, FiveXing otherElement) {
  ...
  static Map<FiveXing, FiveXingRelationship> getShengKeXieHaoTongDict(FiveXing thisElement) {
    return _checkerMapper[thisElement]!;
  }
}

enum FiveXingWangShuai{
  WANG("旺"),
  XIANG("相"),
  XIU("休"),
  QIU("囚"),
  SI("死");
  final String name;
  const FiveXingWangShuai(this.name);
  bool get isStrong => checkStrong(this);
  bool get isWeak => checkWeak(this);
  static FiveXingWangShuai getWangShuaiByName(String name){
    switch (name){
      case "旺":
  ...
  static FiveXingWangShuai getFiveXingWangShuaiAtDiZhi(DiZhi diZhi,FiveXing fiveXing){
  ...
  static bool checkWeak(FiveXingWangShuai wangShuai){
    return [FiveXingWangShuai.XIU, FiveXingWangShuai.QIU,FiveXingWangShuai.SI].contains(wangShuai);
  }
  static bool checkStrong(FiveXingWangShuai wangShuai){
    return [FiveXingWangShuai.WANG, FiveXingWangShuai.XIANG].contains(wangShuai);
  }
}