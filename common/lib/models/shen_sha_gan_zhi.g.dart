...
GanZhiShenSha _$GanZhiShenShaFromJson(Map<String, dynamic> json) =>
    GanZhiShenSha(
      json['name'] as String,
      ...
      (json['locationMapper'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(
            ...
            (e as List<dynamic>)
                .map((e) => $enumDecode(_$JiaZiEnumMap, e))
                .toList()),
      ),
    );

Map<String, dynamic> _$GanZhiShenShaToJson(GanZhiShenSha instance) =>
    <String, dynamic>{
      'name': instance.name,
