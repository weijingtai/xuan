...
class DrawCirclePainter extends CustomPainter {
  ...
  void _paintInnerBorder(Canvas canvas, double center, double radius, double radian){
    ...
    canvas.drawArc(
      Rect.fromCircle(center: Offset(center, center), radius: radius - height / 2 + innerBorderWidth / 2),
      0,
      radian,
      false,
      borderPaint,
  ...
  void _paintOuterBorder(Canvas canvas, double center, double radius, double radian){
    ...
    canvas.drawArc(
      Rect.fromCircle(center: Offset(center, center), radius: radius - height / 2 + outerBorderWidth / 2),
      0,
      radian,
      false,
      borderPaint,
  ...
  // 根据顺时针方向，第二个扇环的垂直边
  void _paintSecondClockwiseVerticalBorder(Canvas canvas, double center, double radius, double radian){
  ...
  // 根据顺时针方向，第二个扇环的垂直边
  void _paintFirstClockwiseVerticalBorder(Canvas canvas, double center, double radius, double radian){
  ...
  void paintFanRing(Canvas canvas, Size size){
    ...
    if (text != null) {
      ...
      drawText(canvas, size, text!, Offset(10, -3),1+angle);
    }


  }
  void drawText(Canvas canvas, Size size, String text, Offset offset,double rotationAngle) {
