...
class _BeautyViewPageState extends State<BeautyViewPage>
  ...
  void initState() {
    ...
    // 计算 UI 星体安全角度，避免重叠（本命与流年）
    final vmForSafety = context.read<QiZhengSiYuViewModel>();
    vmForSafety.calculateBasicStarsSafetyAngle(
      panelSizeDataModel.starBodyRadius,
      panelSizeDataModel.outerLifeStarRingTrackSize,
      panelSizeDataModel.centerSize,
    );
    vmForSafety.calculateFateStarsSafetyAngle(
      panelSizeDataModel.starBodyRadius,
