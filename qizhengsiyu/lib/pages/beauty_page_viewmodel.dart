...
import '../domain/entities/models/panel_stars_info.dart'; // 可能仍然需要用于更详细信息展示，尽管 ElevenStarsInfo 已弃用
...
import '../domain/entities/models/eleven_stars_info.dart'; // 已弃用，但模型本身可能被PanelStarsInfo引用，暂时保留
