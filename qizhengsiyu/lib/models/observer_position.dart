...
class ObserverPosition extends BaseObserverPosition {
  ...
  ObserverPosition({
    ...
    fourZhuEightChar = [lunar.getYearInGanZhi(), lunar.getMonthInGanZhi(), dayGanZhi, lunar.getTimeInGanZhi()].toList().join('');
  }
  ObserverPosition.fromDateTime({
    required DateTime datetime,
    required BaseObserverPosition observer}):this(
      birthday: datetime,
  ...
  static DateTime toUtcTime(String timezone,DateTime datetime){
    tz.TZDateTime shanghaiTime = tz.TZDateTime(tz.getLocation(timezone), datetime.year, datetime.month, datetime.day, datetime.hour, datetime.minute);
