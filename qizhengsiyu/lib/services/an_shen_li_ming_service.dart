...
class AnShenLiMingService {
  ...
  static EnumTwelveGong settleDownBodyGong(ElevenStarsInfo lunarInfo,
      [JiaZi? timeGanZhi, DiZhi liMingDiZhi = DiZhi.YOU]) {
    if (timeGanZhi == null) {
  ...
  static BodyAndLife settleDownBodyAndLife(
    ...
    // 1.2. 确定命度
    Tuple2<TwentyEightStarInn, double> lifeInn =
    ...
    return BodyAndLife(
      ...
      settleBody: EnumSettleBodyType.TiaYin,
      settleLife: EnumSettleLifeType.Mao,
      // lunarLocationIsBody: lunarIsBody
    );
  }

  static Tuple2<TwentyEightStarInn, double> settleDownLifeInn(
    ...
    Iterable<MapEntry<TwentyEightStarInn, StarInnGongDegreeInfo>> iter =
        mapper.entries.where((entry) {
      return entry.value.startAtGongDegree.gong == lifeGong;
    });
    MapEntry<TwentyEightStarInn, StarInnGongDegreeInfo> result =
        iter.firstWhere((e) {
  ...
  static Tuple2<TwentyEightStarInn, double> settleDownBodyInn(
      ElevenStarsInfo lunarInfo) {
  ...
  static Tuple2<TwentyEightStarInn, double> starEnterStarInn(
      double starAngle, Map<TwentyEightStarInn, StarInnGongDegreeInfo> mapper) {
    ...
    MapEntry<TwentyEightStarInn, StarInnGongDegreeInfo> result = mapper.entries
        .firstWhere(
