...
class QiZhengSiYuUIConstantResources {
  static final Map<EnumStars, Color> zhengColorMap = {
    ...
    EnumStars.Water:
        Color.fromRGBO(76, 141, 174, 1), // 23,124,176, 靛青；76,141,174,群青
  ...
  static final Map<EnumStars, Color> starsColorMap = {
    ...
    EnumStars.Bei:
        Color.fromRGBO(66, 80, 102, 1), // 161,175,201，蓝灰； 66,80,102 黛蓝
    EnumStars.Ji:
        Color.fromRGBO(211, 177, 125, 1), // 200,155,64 昏黄； 211,177,125 枯黄
