        ...
        return Routes.fadeThrough(
            ...
            builder: (context) {
              ...
              return ConditionalRouteWidget(
                  ...
                  builder: (context, child) => child!=null?child:ResponsiveScaledBox(
                    ...
                    // Set the fixed width value based on the active breakpoint.
                      width: ResponsiveValue<double>(context, conditionalValues: [
                        ...
                        const Condition.between(start: 0, end: 450, value: 0),
  ...
  Route<dynamic> buildPage(
    ...
    return Routes.noAnimation(
        ...
        builder: (context) {
          ...
          '/' || CrossPlatformMainPage.routeName => const CrossPlatformMainPage(),
