...
class _CrossPlatformMainPageState extends State<CrossPlatformMainPage> {
  ...
  Widget build(BuildContext context) {
    ...
    print('{"mobile":$isMobile,"phone":$isPhone,"tablet":$isTablet,"desktop":$isDesktop,"4K":$is4K}');
        ...
        body: Row(
          children: <Widget>[
            ResponsiveVisibility(
              visible: ResponsiveBreakpoints.of(context).isDesktop || ResponsiveBreakpoints.of(context).isTablet,
              child: ValueListenableBuilder(
                  valueListenable: _selectedIndexNotifier,
                  builder: (ctx,_selectedIndex,_){
                    return NavigationRail(
                      ...
                      [
                        ...
                        NavigationRailDestination(
                          ...
                          label: Text('Wishlist',style: TextStyle(color: Colors.black87),),
                        ),
                        NavigationRailDestination(
                          icon: Icon(Icons.person_outline_rounded),
                          selectedIcon: Icon(Icons.person),
                          label: Text('Account',style: TextStyle(color: Colors.black87)),
                        ),
                        NavigationRailDestination(
                    ...
                    SliverList(
                      delegate: SliverChildBuilderDelegate(
                        childCount: 2,
                          (ctx,index){
                          if (index == 1){
                            return ElevatedButton(onPressed:(){isHorizontalNotifier.value = !isHorizontalNotifier.value;}, child: Text("ok"));
                          }
                          return Stack(
                              children: [
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                ).animate().show(delay: Duration(milliseconds: 600),duration: Duration(milliseconds: 200)),
        ...
        drawer: ResponsiveVisibility(
          ...
          child:ValueListenableBuilder(
            ...
            return NavigationDrawer(
              onDestinationSelected: (index)=>_selectedIndexNotifier.value = index,
              selectedIndex: _selectedIndex,
              children: <Widget>[
                Padding(
