...
class _BeautyPageState extends State<BeautyPage> with TickerProviderStateMixin {
  ...
  // 黄道十二宫 从白羊开始
  List<String> zodiacList = <String>["坎", "艮", "震", "巽", "离", "坤", "兑", "乾",].reversed.toList();
  TextStyle zodiacTextStyle = GoogleFonts.notoSerif(fontSize: 48,color: Colors.black,height: 1);


  // 十二星次 从大梁开始
  TextStyle starTextStyle = TextStyle(color: Colors.grey, fontSize: 12,fontFamily: 'KaiTi',fontWeight: FontWeight.w300,height: 1.2);
  // sixteen gong name
  List<String> sixteenGongNameList = <String>["亥神", "子神", "丑神", "艮神", "寅神", "卯神", "辰神", "巽神", "巳申", "午神", "未神", "坤神", "申神", "酉神", "戌神", "乾神",].reversed.toList();

  // sixteen God
  List<String> sixteenGodsNameList = <String>["大义", "地主", "阳德", "和德", "吕申", "高丛", "太阳", "大炅", "大神", "大威", "天道", "大武", "武德", "大簇", "阴主", "阴德",].reversed.toList();
  ...
  void initState() {
    ...
    zodiacTextList = zodiacList.map((e) => Text("")).toList();
    sixteenGongNameSeq = sixteenGongNameList.map((e) => Text(e,style: GoogleFonts.maShanZheng(fontSize: 16,height: 1))).toList();
    sixteenGodsNameSeq = sixteenGodsNameList.map((e) => Text(e,style: GoogleFonts.maShanZheng(fontSize: 16,height: 1))).toList();
  }
    ...
    return Transform.rotate(
      ...
      child: Container(
        ...
        child: Stack(
          alignment: Alignment.center,
          children: [
            drawRingWithTextList(940, 138, List.generate(16, (index) => Text("")).toList(),innerPadding: 6),
            Transform.rotate(
                angle: (22.5*0*pi)/180,
  ...
  Widget star_gods_tag(String starGod){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(first, style: GoogleFonts.longCang(
              height: 1.0, fontSize: 24, fontWeight: FontWeight.w700),),
          Text(second, style: GoogleFonts.longCang(
              height: 1.0, fontSize: 24, fontWeight: FontWeight.w700))
        ],
      ),
    );
      ...
      child: Stack(
        ...
        children: [
          Container(
            ...
            child: drawRingWithTextList(590, 34, sixteenGongNameSeq,innerPadding: 6),
          ),
          Container(
            width: 664,
            height: 664,
            ...
            child: drawRingWithTextList(660, 32, sixteenGodsNameSeq,innerPadding: 6),
          ),
        ],
      ),
  ...
  Widget eight_gong_ring(){
    ...
    var gongList = [
      ConstantTaiYiNineGongDataClass("易气","冬至","叶蛰", "坎", "捌", Tuple2("子",null)),
      ConstantTaiYiNineGongDataClass("和气","立春","天留", "艮", "叁", Tuple2("丑","寅"),tianMenDiHu: "鬼方"),
      ConstantTaiYiNineGongDataClass("绝气","春分","仓门", "震", "肆", Tuple2("卯",null)),
      ConstantTaiYiNineGongDataClass("绝阴","立夏","阴洛", "巽", "玖", Tuple2("辰","巳"),tianMenDiHu: "地户"),
      ConstantTaiYiNineGongDataClass("易气","夏至","上天", "离", "贰", Tuple2("午",null)),
      ConstantTaiYiNineGongDataClass("和气","立秋","玄委", "坤", "柒", Tuple2("未","申"),tianMenDiHu: "人路"),
      ConstantTaiYiNineGongDataClass("绝气","秋分","苍果", "兑", "陆", Tuple2("酉",null)),
      ConstantTaiYiNineGongDataClass("绝阳","立冬","新洛", "乾", "壹", Tuple2("戌","亥"),tianMenDiHu: "天门"),
    ];
            ...
            Transform.rotate(
              ...
              child: Container(
                  ...
                  child: Stack(
                    alignment: Alignment.center,
                    children: [
                      drawRingWithTextList(519, 120, zodiacTextList,innerPadding: 10,rotatedAngle: 22.5 * pi/360),
                      ...listWidget,
                    ],
                  )
              ),
                      ...
                      children: [
                        Transform.rotate(
                          ...
                          child: Container(
                              ...
                              child: drawRingWithTextList(302, 64, zodiacTextList,innerPadding: 10,rotatedAngle: 22.5 * pi/360)
                          ),
                        ),
                        Transform.rotate(
                          angle: 22.5*pi/180,
                        ...
                        Container(
                          ...
                          child: drawRingWithTextList(372, 32, sixteenGongNameSeq,innerPadding: 6),
                        ),
                        Container(
                          width: 435,
                          height: 435,
                          ...
                          child: drawRingWithTextList(435, 32, sixteenGodsNameSeq,innerPadding: 6),
                        ),
                        Container(
                          width: 720,
                          height: 720,
                          ...
                          child: Stack(
                            alignment: Alignment.center,
                            children: [
                              drawRingWithTextList(720, 142, List.generate(16, (index) => Text("")).toList(),innerPadding: 6),
                              Transform.rotate(
                                angle: (22.5 * 0 * pi) / 180,
                                origin: Offset.zero,
                                child: Container(
                                  margin: EdgeInsets.only(top:516),
                                  color: Colors.black.withOpacity(.1),
                                  height: 56,
                                  width: 24,
                                  child: Column(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Text("太",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700),),
                                      Text("乙",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700))
                                    ],
                                  ),
                                ),
                              ),
                              Transform.rotate(
                                ...
                                origin: Offset.zero,
                                child: Container(
                                  margin: EdgeInsets.only(top:520+56+56+8),
                                  color: Colors.black.withOpacity(.1),
                                  height: 56,
                                  width: 24,
                                  child: Column(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Text("始",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700),),
                                      Text("击",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700))
                                    ],
                                  ),
                                ),
                              ),
                              Transform.rotate(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Text("客",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700),),
                                      Text("大",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700))
                                    ],
                                  ),
                                ),
                              ),
                              Transform.rotate(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      Text("飞",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700),),
                                      Text("符 ",style: GoogleFonts.longCang(height: 1.0,fontSize:24,fontWeight: FontWeight.w700))
                                    ],
                                  ),
                                ),
                              )
  ...
  Widget drawRingWithTextList(
      double size,
      double ringWidth,
      List<Text> contentList,{double innerPadding = 2,double rotatedAngle = 0}){
    double outerRadius = size / 2;
    double innerRadius = outerRadius - ringWidth;
    return Container(
        alignment: Alignment.center,
